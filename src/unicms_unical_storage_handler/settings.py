...
CMS_STORAGE_STRUCTURES_VIEW_PREFIX_PATH = 'structures'
...
CMS_STORAGE_STRUCTURES_URL_VIEW_REGEXP = f'^(?P<webpath>[\/a-zA-Z0-9\.\-\_]*)({CMS_STORAGE_BASE_PATH})/({CMS_STORAGE_STRUCTURES_VIEW_PREFIX_PATH})(/)?$' # noqa
...
CMS_STORAGE_HANDLERS_PATHS = [CMS_STORAGE_BASE_URL_VIEW_REGEXP,
                              ...
                              CMS_STORAGE_STRUCTURES_URL_VIEW_REGEXP
                              ]
...
CMS_STORAGE_APP_REGEXP_URLPATHS = {
    ...
    'unicms_unical_storage_handler.handlers.StructuresListViewHandler': CMS_STORAGE_STRUCTURES_URL_VIEW_REGEXP,
}
...
CMS_STORAGE_STRUCTURES_API = f'{CMS_STORAGE_BASE_API}structures/'
...
CMS_STORAGE_STRUCTURES_LABEL = _("Strutture")
