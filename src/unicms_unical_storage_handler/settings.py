...
CMS_STORAGE_PROJECTS_PROGRAMS_TYPES_API = f'{CMS_STORAGE_BASE_API}program-types/'
CMS_STORAGE_PROJECTS_TERRITORIAL_SCOPES_API = f'{CMS_STORAGE_BASE_API}territorial-scopes/'
