...
# CMS_STORAGE_RESEARCH_GROUP_INFO_URL_VIEW_REGEXP = f'^(?P<webpath>[\/a-zA-Z0-9\.\-\_]*)({CMS_STORAGE_BASE_PATH})/({CMS_STORAGE_RESEARCH_GROUP_VIEW_PREFIX_PATH})/(?P<code>[a-z0-9\-]*)(/)?$' # noqa
...
CMS_STORAGE_HANDLERS_PATHS = [
                              ...
                              # CMS_STORAGE_RESEARCH_GROUP_INFO_URL_VIEW_REGEXP,
...
CMS_STORAGE_APP_REGEXP_URLPATHS = {
    ...
    # 'unicms_unical_storage_handler.handlers.ResearchGroupInfoViewHandler' : CMS_STORAGE_RESEARCH_GROUP_INFO_URL_VIEW_REGEXP,
